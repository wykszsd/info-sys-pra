...
const assignmentSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(fetchTeacherCoursesForAssignments.pending, (state) => { state.isLoadingCourses = true; state.error = null; })
            .addCase(fetchTeacherCoursesForAssignments.fulfilled, (state, action) => { state.isLoadingCourses = false; state.teacherCourses = action.payload; })
            .addCase(fetchTeacherCoursesForAssignments.rejected, (state, action) => { state.isLoadingCourses = false; state.error = typeof action.payload === 'string' ? action.payload : (action.error?.message || '未知错误'); })
